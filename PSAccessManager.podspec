...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Sergey Prikhodko" => "email@address.com" }
  # Or just: spec.author    = "Sergey Prikhodko"
  # spec.authors            = { "Sergey Prikhodko" => "email@address.com" }
  ...
  spec.source       = { :git => "https://github.com/sergey-prikhodko/PSAccessManager.git", :commit => "abbab5d878cdeb3231d57c7001797505f189bc2f" }
